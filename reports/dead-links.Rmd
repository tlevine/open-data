...
Data catalogs with more externally stored data tend to have more dead links.

The above plot was for just Socrata; let's see what happens when we add CKAN.

<!--
here's a relationship it's harder (practically
impossible) to have dead links on internally stored data. 
As I explain [below](#software-suggests-behaviour),
-->

...
I really just issued a HEAD request and checked the status code.)
...
Rather than looking at just whether there are any external links at all,
let's now look at what proportion of the datasets are external links

```{r software, fig.width = 8, fig.height = 6}
p.software
```
{:.wide}

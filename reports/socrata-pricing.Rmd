...
## Pricing structure
It looks like you're getting one packaged website from Socrata, but
it's sold as a bunch of different products.
...
### GovStat
GovStat is a big product (in terms of cost) that I didn't look at.
Given its cost, I felt like it deserved its own section even though

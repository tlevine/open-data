...
```{r fancy, echo = FALSE, fig.height = 8, fig.width = 12}
p.fancy
```
{:.wide}
...
levels(catalogs$data.portal.plan)[1:3] <- c('Basic','Extended','Enterprise')
levels(catalogs$data.collect.plan)[2:4] <- c('Basic','Extended','Enterprise')

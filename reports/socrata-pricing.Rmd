...
I collected four numbers ([variables]()) for each data portal.
...
I [called the search API](),
downloaded lots of files, and
[put them into an SQLite3 database]().
Then I ran the following
[queries]().

To count **datasets**, I
[removed federation and derived views]()
in order to arrive at the number of [tables]() per data portal.
